...
CREATE TABLE `go_db_role` (
  ...
  `role_note` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `fk_user_role_role` FOREIGN KEY (`role_id`) REFERENCES `go_db_role` (`id`),
  CONSTRAINT `fk_user_role_user` FOREIGN KEY (`user_id`) REFERENCES `go_db_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-15 14:51:14
